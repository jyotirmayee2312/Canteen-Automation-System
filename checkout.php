...
$results=mysqli_query($db, "SELECT * FROM cart where email='$email'") or die(mysqli_error());
 ?>
<html>
<head>
...
<div class="header">
		...
		<div class="container">
				...
				<div class="logo">
				<h1 ><a href="index.php">CLICK WHEN HUNGRY<span>The Best Canteen</span></a></h1>
			</div>
			<div class="head-t">
				<ul class="card">
...
<div class="banner-top">
 ...
 <table class="table ">
		 <?php 
            ...
            mysqli_select_db($db, "ecommerce");
			$products=mysqli_query($db, "SELECT * FROM cart") or die(mysqli_error());
